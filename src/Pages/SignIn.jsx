      ...
      <div className="w-full h-screen">
        ...
        <div className="fixed w-full px-4 py-10 z-50">
          <div className="text-white text-center items-center mt-[2rem] mb-1">
            <Link to={"/"}>
              <h1 className="text-3xl md:text-4xl mb-2 font-bold">Trebbo</h1>
            </Link>
          ...
          <div className="max-w-[320px] md:max-w-[500px] mx-auto mt-[2rem] md:mt-[-1rem] lg:mt-[6rem] py-10">
            <form className="w-full flex flex-col py-4">
              ...
              <p className="text-center hover:text-[#A80ACF] text-white text-[0.9rem] md:text-lg mt-4 mb-1">
                Forgot Password?
              </p>
              <button
                onClick={goHome}
              ...
              <p className="py-5 mt-[-0.5rem] md:text-lg text-center text-white">
                ...
                {/* Sign In with google */}
                <div className="my-2 mx-9 md:mx-[8rem] lg:mx-[8rem]">
                  <GoogleLogin
                    onSuccess={(credentialResponse) => {
                      // Decode with jwt & setUser
