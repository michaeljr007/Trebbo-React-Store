    ...
    <div>
      <div className="mt-[4rem]">
        <div className="p-5 ml-[0.4rem] mr-[2rem] mt-1">
          <h1 className="font-semibold flex text-lg mb-1 md:text-xl">
            Hi,{" "}
            <span className="text-purple-800 ml-1">
              {/* Show name if signed In */}
              {profileArray.length > 0 ? profile.firstName : <p>Shopper</p>}
            </span>
          </h1>
        ...
        <div className="pb-6 pt-7 rounded-t-[2rem] bg-gray-100">
          <h1 className="font-semibold text-center text-white py-1 my-1 rounded-lg px-4 mx-[12.8rem] md:mx-[15.8rem] lg:mx-[19rem] ml-6 bg-[#A80ACF]">
            Today's Picks
          </h1>

          {/* Main product row of random products */}
          <MainRow rowID="1" url={products} />

          {/* Display Rows of different products */}
