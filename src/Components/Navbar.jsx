...
const Navbar = () => {
  ...
  return (
    <div>
      <div className="flex justify-between mt-[-3.9rem] items-center p-3 w-[98%] z-[100] absolute">
        <HamburgerMenu />
        <Link to={"/"}>
        ...
        <div>
          {profileArray.length > 0 ? (
            ...
            <Link to={"/signin"}>
              <button className="group relative mt-[-0.8rem] md:mt-0 mr-[-2.3rem] md:mr-[-1rem] lg:mr-[1rem] overflow-hidden rounded-[0.5rem] cursor-pointer py-[0.3rem] text-white bg-[#A80ACF] shadow px-4">
